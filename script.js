...
document.getElementById('myProgressBar').onchange = () => {
    if(audioElement.duration) audioElement.currentTime = document.getElementById('myProgressBar').value * audioElement.duration / 100;
};
